...
Examples:
  ...
  python -m midi_drums prompt "aggressive death metal breakdown" --tempo 180 -o breakdown.mid
    ...
    # Riff lock command (requires midi_drums[rfi])
    ...
    riff_parser.add_argument("--bpm", type=int, default=120)
    riff_parser.add_argument("--section", default="verse")
    riff_parser.add_argument("--bars", type=int, default=4)
    ...
    riff_parser.add_argument("--audio-duration", type=float, default=None)
    riff_parser.add_argument("-o", "--output")
...
def handle_riff_command(args, generator) -> None:
    ...
    out = args.output or "riff_output.mid"
    generator.export_pattern_midi(riff_locked, out, tempo=args.bpm)
    print(f"\n✓ Done! Output: {out}")
